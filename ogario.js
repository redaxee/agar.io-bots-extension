function init(window, ogario, JQuery) {
    ...
    window.recaptchaExecuteLoop = function() {
        ...
        grecaptcha.execute(0, {
            ...
            if (window.myTurn) return Connection._sendNick(window.lastNick, grecaptcha.getResponse());
    ...
    const displayText = {
        pl: {
            start: `Start`,
            settings: `Ustawienia`,
            restoreSettings: `PrzywrÃ³c ustawienia domyÅ›lne`,
            ...
            skinsGroup: `Skiny`,
            foodGroup: `Pokarm`,
            transparencyGroup: `PrzezroczystoÅ›Ä‡ / kolory`,
            gridGroup: `Siatka / sektory`,
            miniMapGroup: `Minimapa`,
            helpersGroup: `Wspomagacze`,
            mouseGroup: `Sterowanie myszkÄ…`,
            hudGroup: `HUD`,
            chatGroup: `Czat`,
            statsGroup: 'Statystyki',
            extrasGroup: `Dodatkowe`,
            noSkins: `WyÅ‚Ä…cz skiny`,
            noNames: 'WyÅ‚Ä…cz nazwy',
            noColors: `WyÅ‚Ä…cz kolory`,
            showMass: 'PokaÅ¼ masÄ™',
            skipStats: `PomiÅ„ statystyki po Å›mierci`,
            showQuest: `PokaÅ¼ zadanie (quest)`,
            autoZoom: `Auto zoom`,
            animation: `OpÃ³Åºnienie animacji`,
            zoomSpeedValue: `SzybkoÅ›Ä‡ zoomu`,
            ...
            hideMyName: `Ukryj wÅ‚asnÄ… nazwÄ™`,
            hideTeammatesNames: `Ukryj nazwy graczy teamu`,
            optimizedMass: `Zoptymalizowana masa (+/-2%)`,
            shortMass: `SkrÃ³cona masa (k)`,
            virMassShots: `Licznik strzaÅ‚Ã³w (wirusy)`,
            hideMyMass: `Ukryj wÅ‚asnÄ… masÄ™`,
            hideEnemiesMass: 'Ukryj masÄ™ przeciwnikÃ³w',
            vanillaSkins: `Podstawowe skiny`,
            customSkins: 'WÅ‚asne skiny',
            myTransparentSkin: `MÃ³j przezroczysty skin`,
            myCustomColor: `MÃ³j wÅ‚asny kolor`,
            ...
            showMiniMap: `PokaÅ¼ minimapÄ™`,
            showMiniMapGrid: `PokaÅ¼ siatkÄ™ minimapy`,
            showMiniMapGuides: 'PokaÅ¼ prowadnice na minimapie',
            showMiniMapGhostCells: `PokaÅ¼ duchy kulek na minimapie`,
            oneColoredTeammates: `Jednokolorowi gracze`,
            optimizedFood: 'Zoptymalizowany pokarm',
            rainbowFood: `Kolorowy pokarm`,
            oppColors: 'Kolory przeciwnikÃ³w',
            oppRings: `Ringi przeciwnikÃ³w`,
            virColors: `Kolory wirusÃ³w`,
            splitRange: `ZasiÄ™g podziaÅ‚u`,
            virusesRange: `ZasiÄ™g wirusÃ³w`,
            textStroke: `ObwÃ³dki nazw i masy`,
            namesStroke: `ObwÃ³dki nazw`,
            massStroke: `ObwÃ³dki masy`,
            cursorTracking: 'Åšledzenie kursora',
            teammatesInd: `WskaÅºniki graczy teamu`,
            mouseSplit: `LPM - Split myszkÄ…`,
            mouseFeed: `PPM - Feed myszkÄ…`,
            mouseInvert: `OdwrÃ³Ä‡ klawisze myszki`,
            disableChat: `WyÅ‚Ä…cz czat`,
            hideChat: `Ukryj czat`,
            chatSounds: 'Powiadomienia dÅºwiÄ™kowe',
            chatEmoticons: `Emotikony`,
            showChatImages: 'PokaÅ¼ obrazki na czacie',
            showChatVideos: 'PokaÅ¼ filmiki na czacie',
            showChatBox: `Czatbox zamiast wyskakujÄ…cych wiadomoÅ›ci`,
            messageSound: `DÅºwiÄ™k powiadomienia o wiadomoÅ›ci`,
            commandSound: `DÅºwiÄ™k powiadomienia o komendzie`,
            showTop5: `PokaÅ¼ top 5 teamu`,
            showTargeting: 'PokaÅ¼ namierzanie',
            showTime: `PokaÅ¼ aktualny czas`,
            showLbData: 'PokaÅ¼ masÄ™ w topce',
            normalLb: `NagÅ‚Ã³wek "Topka"`,
            centeredLb: `WyÅ›rodkowana topka`,
            fpsAtTop: `Statystyki na gÃ³rze`,
            ...
            'hk-inst-assign': `Aby ustawiÄ‡ skrÃ³t klawiszowy kliknij na polu skrÃ³tu i naciÅ›nij wybrany klawisz.`,
            'hk-inst-delete': `Aby usunÄ…Ä‡ skrÃ³t klawiszowy kliknij na polu skrÃ³tu i naciÅ›nij klawisz DELETE.`,
            'hk-inst-keys': `MoÅ¼liwe kombinacje skrÃ³tÃ³w klawiszowych z uÅ¼yciem klawiszy CTRL oraz ALT.`,
            ...
            'hk-split': `PodziaÅ‚`,
            'hk-doubleSplit': `PodwÃ³jny podziaÅ‚`,
            'hk-split16': `PodziaÅ‚ na 16`,
            'hk-pause': `Pauza kulki`,
            'hk-showTop5': `PokaÅ¼/ukryj top 5 teamu`,
            'hk-showTime': `PokaÅ¼/ukryj aktualny czas`,
            'hk-showSplitRange': `PokaÅ¼/ukryj zasiÄ™g podziaÅ‚u`,
            'hk-showSplitInd': `PokaÅ¼/ukryj zasiÄ™g podziaÅ‚u z ringami`,
            'hk-showTeammatesInd': `PokaÅ¼/ukryj wskaÅºniki graczy teamu`,
            'hk-showOppColors': `PokaÅ¼/ukryj kolory przeciwnikÃ³w`,
            'hk-toggleSkins': `PrzeÅ‚Ä…cz skiny (wÅ‚asne/standardowe)`,
            'hk-showSkins': `PokaÅ¼/ukryj skiny`,
            'hk-transparentSkins': `WÅ‚Ä…cz/wyÅ‚Ä…cz przezroczyste skiny`,
            'hk-showStats': `PokaÅ¼/ukryj statystyki gry`,
            'hk-toggleCells': `PrzeÅ‚Ä…cz kulkÄ™ (najmniejsza/najwiÄ™ksza)`,
            'hk-showFood': 'PokaÅ¼/ukryj pokarm',
            'hk-showGrid': 'PokaÅ¼/ukryj siatkÄ™',
            'hk-showMiniMapGuides': `PokaÅ¼/ukryj prowadnice na minimapie`,
            'hk-hideChat': `PokaÅ¼/ukryj czat`,
            'hk-showHUD': `PokaÅ¼/ukryj HUD`,
            'hk-copyLb': `Kopiuj topkÄ™`,
            'hk-showLb': `PokaÅ¼/ukryj topkÄ™`,
            'hk-toggleAutoZoom': 'WÅ‚Ä…cz/wyÅ‚Ä…cz auto zoom',
            'hk-resetZoom': `Reset zoomu`,
            'hk-zoomLevel': `Zoom - poziom`,
            'hk-toggleDeath': `PrzeÅ‚Ä…cz miejsce Å›mierci`,
            'hk-clearChat': `PokaÅ¼ historiÄ™ czatu / CzyÅ›Ä‡ czat`,
            'hk-showBgSectors': 'PokaÅ¼/ukryj sektory w tle',
            'hk-hideBots': 'PokaÅ¼/ukryj maÅ‚e boty',
            'hk-showNames': `PokaÅ¼/ukryj nazwy`,
            'hk-hideTeammatesNames': `PokaÅ¼/ukryj nazwy graczy teamu`,
            'hk-showMass': 'PokaÅ¼/ukryj masÄ™',
            'hk-showMiniMap': `PokaÅ¼/ukryj minimapÄ™`,
            'hk-chatMessage': `Napisz wiadomoÅ›Ä‡ na czacie`,
            'hk-quickResp': `Szybkie odrodzenie (respawn)`,
            'hk-autoResp': `WÅ‚Ä…cz/wyÅ‚acz auto odrodzenie`,
            'hk-switchServerMode': `PrzeÅ‚Ä…cz serwer [publiczny/prywatny]`,
            'hk-showTargeting': `PokaÅ¼/ukryj panel namierzania`,
            'hk-setTargeting': 'WÅ‚Ä…cz/wyÅ‚Ä…cz namierzanie (Å›ledzenie)',
            'hk-cancelTargeting': `Zatrzymaj namierzanie`,
            'hk-changeTarget': `ZmieÅ„ cel`,
            'hk-privateMiniMap': `PokaÅ¼ cel na minimapie`,
            'hk-showQuest': `PokaÅ¼/ukryj zadanie`,
            commands: `Komendy`,
            comm1: 'Feeduj!',
            comm2: 'Dziel siÄ™!',
            comm3: `Pomocy na %currentSector%!`,
            comm4: `WrÃ³g na %currentSector%!`,
            comm5: `Zabij pomocnika!`,
            comm6: `Strzel z wirusa!`,
            comm7: `Zjedz wirusa!`,
            comm8: `ZjebaÅ‚em, wybacz.`,
            comm9: `Ja pierdolÄ™...`,
            comm0: `Kurwa maÄ‡!`,
            comm10: 'Trick!',
            comm11: `Lewo!`,
            ...
            theme: 'WyglÄ…d',
            restoreThemeSettings: `PrzywrÃ³c ustawienia domyÅ›lne wyglÄ…du`,
            basicTheming: `Podstawowy`,
            themePreset: `Motyw`,
            themeType: 'Typ motywu',
            darkTheme: `Ciemny motyw`,
            lightTheme: 'Jasny motyw',
            mainColor: `Kolor gÅ‚Ã³wny`,
            bgColor: 'TÅ‚o',
            bordersColor: `Granice mapy`,
            gridColor: `Siatka`,
            sectorsColor: `Czcionka sektorÃ³w`,
            namesColor: `Nazwy`,
            namesStrokeColor: `ObwÃ³dki nazw`,
            massColor: `Masa`,
            massStrokeColor: `ObwÃ³dki masy`,
            virusColor: `Wirusy`,
            virusStrokeColor: 'ObwÃ³dki wirusÃ³w',
            foodColor: `Pokarm`,
            namesFont: 'Czcionka nazw',
            massFont: `Czcionka masy`,
            sectorsFont: `Czcionka sektorÃ³w`,
            namesScale: 'Skala nazw',
            massScale: 'Skala masy',
            virMassScale: `Skala masy wirusÃ³w`,
            strokeScale: `Skala obwÃ³dek tekstu`,
            foodSize: 'WielkoÅ›Ä‡ pokarmu',
            bordersWidth: 'GruboÅ›Ä‡ granic mapy',
            sectorsWidth: `GruboÅ›Ä‡ siatki sektorÃ³w`,
            sectorsFontSize: `Rozmiar czcionki sektorÃ³w`,
            cellsAlpha: `PrzezroczystoÅ›Ä‡ kulek`,
            skinsAlpha: `PrzezroczystoÅ›Ä‡ skinÃ³w`,
            virusAlpha: `PrzezroczystoÅ›Ä‡ wirusÃ³w`,
            textAlpha: 'PrzezroczystoÅ›Ä‡ nazw i masy',
            virusStrokeSize: `GruboÅ›Ä‡ obwÃ³dki wirusÃ³w`,
            teammatesIndColor: `WskaÅºnik gracza`,
            cursorTrackingColor: 'Åšledzenie kursora',
            splitRangeColor: `ZasiÄ™g podziaÅ‚u`,
            safeAreaColor: `Bezpieczna strefa`,
            dangerAreaColor: 'Strefa zagroÅ¼enia',
            ghostCellsColor: `Duchy kulek`,
            ghostCellsAlpha: 'PrzezroczystoÅ›Ä‡ duchÃ³w kulek',
            menuTheming: `Menu`,
            menuPreset: `Motyw menu`,
            menuMainColor: `Kolor gÅ‚Ã³wny`,
            ...
            menuBg: 'Grafika tÅ‚a panelu',
            menuOpacity: 'PrzezroczystoÅ›Ä‡',
            hudTheming: `HUD`,
            hudMainColor: `Kolor gÅ‚Ã³wny`,
            hudColor: `TÅ‚o`,
            hudTextColor: 'Tekst',
            ...
            hudScale: `Skala HUD`,
            chatTheming: 'Czat',
            messageColor: 'TÅ‚o wiadomoÅ›ci',
            messageTextColor: 'Tekst wiadomoÅ›ci',
            messageTimeColor: `Czas wiadomoÅ›ci`,
            messageNickColor: `Nick wiadomoÅ›ci`,
            commandsColor: `TÅ‚o komendy`,
            commandsTextColor: `Tekst komendy`,
            commandsTimeColor: 'Czas komendy',
            commandsNickColor: `Nick komendy`,
            chatBoxColor: `TÅ‚o czatboxu`,
            ...
            miniMapNickStrokeColor: `ObwÃ³dka nicku`,
            miniMapMyCellColor: 'Moja kulka',
            miniMapMyCellStrokeColor: `ObwÃ³dka mojej kulki`,
            miniMapTeammatesColor: 'Gracze',
            miniMapDeathLocationColor: `Miejsce Å›mierci`,
            miniMapFont: `Czcionka minimapy`,
            miniMapNickFont: `Czcionka nicku`,
            miniMapWidth: `SzerokoÅ›Ä‡ minimapy`,
            miniMapSectorsOpacity: 'PrzezroczystoÅ›Ä‡ sektorÃ³w',
            miniMapNickSize: `Rozmiar nicku`,
            miniMapNickStrokeSize: `GruboÅ›Ä‡ obwÃ³dki nicku`,
            miniMapMyCellSize: `WielkoÅ›Ä‡ mojej kulki`,
            miniMapMyCellStrokeSize: `GruboÅ›Ä‡ obwÃ³dki mojej kulki`,
            miniMapTeammatesSize: `WielkoÅ›Ä‡ graczy`,
            miniMapGhostCellsColor: `Duchy kulek`,
            miniMapGhostCellsAlpha: `PrzezroczystoÅ›Ä‡ duchÃ³w kulek`,
            imagesTheming: 'Grafika / kursory',
            customBackground: `Grafika tÅ‚a`,
            customCursor: `Grafika kursora`,
            hideChatMsgA: `Czat zostaÅ‚ wÅ‚Ä…czony!`,
            hideChatMsgB: `Czat zostaÅ‚ ukryty!`,
            showSkinsMsgA: 'Skiny zostaÅ‚y wÅ‚Ä…czone!',
            showSkinsMsgB: `Skiny zostaÅ‚y ukryte!`,
            hideSmallBotsMsgA: 'MaÅ‚e boty staÅ‚y siÄ™ widoczne!',
            hideSmallBotsMsgB: 'MaÅ‚e boty zostaÅ‚y ukryte!',
            autoRespMsgA: `Auto odrodzenie zostaÅ‚o wÅ‚Ä…czone!`,
            autoRespMsgB: `Auto odrodzenie zostaÅ‚o wyÅ‚Ä…czone!`,
            autoZoomMsgA: `Auto zoom zostaÅ‚ wÅ‚Ä…czony!`,
            autoZoomMsgB: 'Auto zoom zostaÅ‚ wyÅ‚Ä…czony!',
            targetNotSet: `Brak celu`,
            targetDead: `Nie Å¼yje`,
            targetDistance: 'Dystans',
            targetMass: `Masa razem`,
            totalPartyPlayers: 'Aktywnych graczy',
            totalPartyMass: 'ÅÄ…cznie masy',
            exportImport: `Eksport / import ustawieÅ„`,
            exportSettings: `Eksportuj ustawienia`,
            exportInfo: 'Aby wyeksportowaÄ‡ wybrane ustawienia skopiuj poniÅ¼szy kod i zapisz go w pliku tekstowym z kodowaniem Unicode.',
            importSettings: 'Importuj ustawienia',
            importInfo: `Aby zaimportowaÄ‡ wybrane ustawienia wklej poniÅ¼ej wyeksportowany wczeÅ›niej kod i naciÅ›nij przycisk "Importuj ustawienia".`,
            profile: `Profil`,
            profiles: `Profile`,
            skins: 'Skiny',
            moreSkins: `Dodaj skiny`,
            thanks: `DziÄ™ki Awesome!`,
            saveSett: `Zapisz ustawienia`,
            saved: 'Zapisano!',
            resetSett: `Resetuj ustawienia`,
            close: `Zamknij`,
            enterChatMsg: `Napisz wiadomoÅ›Ä‡`,
            activeParties: `Aktywne party`,
            noActiveParties: `Brak aktywnych party ;(`,
            playlist: `Playlista`,
            pause: `PAUZA!`,
            visit: `OdwiedÅº`,
            exit: 'OGARio by szymy: Czy na pewno chcesz opuÅ›cic grÄ™?',
            blockWarn: `UWAGA! Popupy zostaÅ‚y zablokowane w ustawieniach.`,
            unblockPopups: `Odblokuj tymczasowo`,
            mass: `Masa`,
            score: `Top`,
            leaderboard: `Topka`,
            user: `UÅ¼ytkownik`,
            userMuted: `UÅ¼ytkownik %user% zostaÅ‚ wyciszony.`,
            userUnmuted: `WyÅ‚Ä…czono wyciszenie uÅ¼ytkownika %user%.`,
            mute: `Wycisz`,
            unmute: 'WyÅ‚Ä…cz wyciszenie',
            mutedUsers: `Wyciszeni uÅ¼ytkownicy`,
            activeUsers: `Aktywni uÅ¼ytkownicy`,
            showActiveUsers: 'PokaÅ¼ aktywnych uÅ¼ytkownikÃ³w',
            none: `Brak`,
            sounds: 'DÅºwiÄ™ki',
            page_back_button: `WrÃ³Ä‡`,
            page_create_party: `StwÃ³rz party`,
            page_join_party: `DoÅ‚Ä…cz`,
            ...
            page_party_join_error: 'Nie moÅ¼na doÅ‚Ä…czyÄ‡ do tego party. Upewnij siÄ™, Å¼e token jest prawidÅ‚owy lub stwÃ³rz nowy.',
            page_play: `Graj`,
            page_play_as_guest: `Graj jako goÅ›Ä‡`,
            page_shop: `Sklep`,
    ...
    const application = {
        ...
        setMenu() {
            ...
            JQuery('#nick').before(`<input id="clantag" class="form-control" placeholder="Tag, e.g. â“‚" maxlength="10"><div class="input-group nick"></div>`);
            ...
            JQuery(`.agario-shop-panel`).after(`<div class="agario-panel ogario-yt-panel"><h5 class="menu-main-color">Team OGARio (tag: â“‚)</h5><div class="g-ytsubscribe" data-channelid="UCaWiPNJWnhzYDrBQoXokn6w" data-layout="full" data-theme="dark" data-count="default"></div></div>`);
            ...
            JQuery(`#music`).append(`<div class="agario-panel ogario-yt-panel"><h5 class="menu-main-color">Team OGARio (tag: â“‚)</h5><div class="g-ytsubscribe" data-channelid="UCaWiPNJWnhzYDrBQoXokn6w" data-layout="full" data-theme="dark" data-count="default"></div></div>`);
        ...
        switchServerMode() {
            ...
            if (this.isSocketOpen()) {
                this.closeConnection();
                toastr.error(`ZamkniÄ™to poÅ‚Ä…czenie z serwerem!`);
            }
            if (this.privateMode) {
                toastr.info(`PrzeÅ‚Ä…czono na serwer prywatny!`);
                JQuery(`.party-panel`).show();
            } else {
                toastr.info(`PrzeÅ‚Ä…czono na serwer publiczny!`);
    ...
    window.Connection = {
        ...
        connect(url) {
            ...
            if (!this.v3) {
                this.v3 = true, this.addRecaptchaV3();
        ...
        addRecaptchaV3() {
            var v3window = document.createElement("div");v3window.id="captchaWindowV3";v3window.style="display:none";
        ...
        sendNick(nick) {
            ...
            window.myTurn = true;
            let botServerIsOnline = (window.connection && window.connection.ws && window.connection.ws.readyState === 1);
            if (!botServerIsOnline) recaptchaExecuteLoop();
        },
        _sendNick(nick, token) {
            this.playerNick = nick;
            nick = window.unescape(window.encodeURIComponent(nick));
            const view = this.createView(3 + nick.length + token.length);
            let buftes = [];
            for (let i = 0; i < 3 + nick.length + token.length; i++) buftes.push(0);
            ...
            for (let len = 0; len < token.length; len++) {
                view.setUint8(nick.length + 2 + len, token.charCodeAt(len));
