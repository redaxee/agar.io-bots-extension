...
class Client {
    ...
    createUUID() {
        ...
        localStorage.setItem('ExhaleGlory3UUID', token);
        return token;
    }
    ...
    loadCSS() {
        ...
        if (!localStorage.getItem('ExhaleGlory3UUID')) localStorage.setItem('ExhaleGlory3UUID', this.createUUID());
        this.uuid = localStorage.getItem('ExhaleGlory3UUID');
    }

    loadGUI() {
        $('.agario-promo-container').replaceWith(`
        <input onchange="localStorage.setItem('botNick', this.value);" id="botNick" maxlength="15" class="form-control" placeholder="Bot Name" value="BOT-ExhaleGlory"></input>
        <input onchange="localStorage.setItem('botAmount', this.value);" id="BotAmount" maxlength="3" class="form-control" placeholder="Bot Amount" value="999"></input>
        ...
        if (!localStorage.getItem('botNick')) localStorage.setItem('botNick', 'BOT-ExhaleGlory');
        console.log('[ExhaleGlory] Ready!');
    }
    ...
    startBots(amount) {
        ...
        console.log(`[ExhaleGlory] Starting ${localStorage.getItem('botAmount')} bots!`);
    ...
    stopBots() {
        ...
        this.bots.length = 0;
        console.log('[ExhaleGlory] Stopped bots!');
